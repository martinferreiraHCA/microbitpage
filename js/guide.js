...
(function (global) {
  ...
  const STEPS = [
    ...
    { title: '7. Fondo con imagen e indicadores', target: '#btn-bg', html: `
      ...
      <p>Elegí "Sin fondo" y desactivá "Mostrar título" en las propiedades para que los indicadores floten sobre la imagen. Mirá el ejemplo <b>🏠 Casa inteligente</b>.</p>`, action: { label: 'Cargar ejemplo Casa inteligente', fn: () => App.loadExample(2) } },
