...
(function (global) {
  ...
  const STEPS = [
    ...
    { title: '1. Programá el micro:bit', target: '#btn-microbit-code', html: `
      ...
      <p>Abrí <b>🧠 Código micro:bit</b>, elegí los sensores, copiá el código en <a href="https://makecode.microbit.org" target="_blank" rel="noopener">MakeCode</a> (pestaña JavaScript) y descargalo al micro:bit.</p>
    ...
    { title: '2. Conectá el micro:bit', target: '#btn-connect', html: `
      <p>Usá <b>Chrome o Edge</b>, conectá el micro:bit por USB y presioná <b>🔌 Conectar</b>. Elegí el dispositivo "BBC micro:bit CMSIS-DAP" en la ventana.</p>
      <p>¿Sin micro:bit? Activá <b>🎲 Simulador</b>: genera datos de prueba con los nombres <code>temp</code>, <code>luz</code> y <code>sonido</code>.</p>`, action: { label: 'Activar simulador', fn: () => Simulator.start() } },
    { title: '3. Mirá los datos que llegan', target: '#add-btn', html: `
      <p>Agregá al panel una <b>Tabla de variables</b> o una <b>Consola serial</b> (menú ➕ Agregar). Vas a ver cada variable con su valor en tiempo real.</p>
    ...
    { title: '7. Fondo con imagen e indicadores', target: '#btn-bg', html: `
      <p>Con <b>🖼️ Fondo</b> podés poner una foto o un plano (por ejemplo, de tu aula o de una maqueta) y ubicar encima <b>luces</b>, <b>valores</b> y <b>textos</b>.</p>
      <p>Activá "Sin tarjeta" y desactivá "Mostrar título" en las propiedades para que los indicadores floten sobre la imagen. Mirá el ejemplo <b>🏠 Casa inteligente</b>.</p>`, action: { label: 'Cargar ejemplo Casa inteligente', fn: () => App.loadExample(2) } },
    ...
    { title: '10. Modo panel, pantalla completa y embeber', target: '#btn-panel-mode', html: `
      <p><b>🖥️ Modo panel</b> oculta el editor y muestra solo tu interfaz; <b>⛶</b> la pone en pantalla completa (ideal para un monitor en el aula).</p>
      <p>Con <b>🔗 Embeber</b> obtenés un código <code>&lt;iframe&gt;</code> para mostrar el panel dentro de otra página (un blog, un aula virtual, o un generador de código de micro:bit como ml-microbit) y la API para mandarle datos desde afuera.</p>
